  ...
  theme: {
    extend: {
      fontSize: {
        ...
        'xxs-bold': ['10px', { fontWeight: '700' }],
        'xxs-semibold': ['10px', { fontWeight: '600' }],
        'xxs-medium': ['10px', { fontWeight: '500' }],
        'xxs-regular': ['10px', { fontWeight: '400' }],
        'xxs-light': ['10px', { fontWeight: '300' }],
      },
    },
  },
  plugins: [],
