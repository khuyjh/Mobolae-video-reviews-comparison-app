...
function Cell({ className = '' }: { className?: string }) {
  return <div className={`bg-black-700/50 h-5 w-full animate-pulse rounded ${className}`} />;
}
...
// 요약 스켈레톤 (CompareResultSummary 자리)
 ...
 * - pending 구간에서 사용
 */
export default function CompareResultSkeleton() {
  return (
