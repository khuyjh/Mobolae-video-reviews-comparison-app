...
export const signUpRequest = async (data: SignUpSchema): Promise<AuthResponse> => {
  try {
    const res = await publicApiClient.post(`${TEAM_ID}/auth/signUp`, data);
    return res.data;
  } catch (e) {
...
export const signInRequest = async (data: SignInSchema): Promise<AuthResponse> => {
  try {
    const res = await publicApiClient.post(`${TEAM_ID}/auth/signin`, data);
    return res.data;
  } catch (e) {
...
export const getMe = async (): Promise<DetailUser> => {
  try {
    const res = await privateApiClient.get(`${TEAM_ID}/users/me`);
    return res.data;
  } catch (e) {
...
export const kakaoSignInRequest = async (data: KakaoLoginData): Promise<AuthResponse> => {
  try {
    const res = await publicApiClient.post(`${TEAM_ID}/auth/signIn/kakao`, data);
    return res.data;
  } catch (e) {
...
export const kakaoSignUpRequest = async (data: KakaoSignUpData): Promise<AuthResponse> => {
  try {
    const res = await publicApiClient.post(`${TEAM_ID}/auth/signUp/kakao`, data);
    return res.data;
  } catch (e) {
